            ...
            <a-row :gutter="12">
              ...
              <a-col :span="4">
                <a-select v-model="filter.relation" style="width: 100%">
                  <a-option
                    v-for="relation in getColRelations(filter.colName)"
                    :value="relation"
                  >
                    {{ relation }}
                  </a-option>
              ...
              <a-col
                :span="12"
                v-if="
                  getColTypeByName(filter.colName) === '文本' &&
              ...
              <a-col
                :span="12"
                v-if="
                  getColTypeByName(filter.colName) === '枚举' &&
                  !['为空', '不为空'].includes(filter.relation)
                "
              >
                <a-select
              ...
              <a-col
                :span="12"
                v-if="
                  getColTypeByName(filter.colName) === '时间' &&
                  !['为空', '不为空'].includes(filter.relation)
                "
              >
                <a-date-picker
              ...
              <a-col
                :span="8"
                v-if="
                  getColTypeByName(filter.colName) === '业务标签' &&
                  !['为空', '不为空'].includes(filter.relation)
                "
              >
                <a-input
